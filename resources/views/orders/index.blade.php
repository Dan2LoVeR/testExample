...
<body>
    <div class="flex mt-10 ml-10 flex-col md:flex-row justify-between items-center mb-6">
        <h1 class="text-2xl text-bold">Список заказов</h1>
        ...
        <table class="w-full table-auto">
            <thead>
                <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                    ...
                    <th class="py-3 px-6 text-left">ФИО Покупателя</th>
                    <th class="py-3 px-6 text-left">Дата создания</th>
                    <th class="py-3 px-6 text-left">Статус</th>
                    <th class="py-3 px-6 text-left">Итоговая цена</th>
            ...
            <tbody class="text-gray-600 text-sm">
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                    ...
                    <td class="py-3 px-6 text-left">{{ $order->total_price }} руб.</td>
                    <td class="py-3 px-6 text-center">
                        <div class="flex item-center justify-center">
                            <a class="w-4 mr-2 transform hover:text-green-500 hover:scale-110" href="{{ route('orders.show', $order) }}">
                            ...
                            <a class="w-4 mr-2 transform hover:text-blue-500 hover:scale-110" href="{{ route('orders.edit', $order) }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                </svg>
                            </a>
                            <form action="{{ route('orders.destroy', $order) }}" method="POST" style="display:inline;" class="w-4 mr-2 transform hover:text-red-500 hover:scale-110" >
